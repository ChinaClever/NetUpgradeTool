...
public:
    ...
    static void RSASignFile(const QString& privFilename, const QString& messageFilename ,const QString& signatureFilename)
    {
        crypto.RSASignFile(privFilename.toUtf8(), messageFilename.toUtf8() , signatureFilename.toUtf8());
    }
